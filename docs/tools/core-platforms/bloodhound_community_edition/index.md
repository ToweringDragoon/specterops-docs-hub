...
<CardGroup cols={2}>
  <Card title="Repository" icon="github" href="https://github.com/SpecterOps/BloodHound">
    SpecterOps/BloodHound
  </Card>
  <Card title="Quick Access" icon="link" href="https://bloodhound.yourdomain.com">
    bloodhound.yourdomain.com
  </Card>
</CardGroup>
...
Attack path analysis for Active Directory and Azure environments

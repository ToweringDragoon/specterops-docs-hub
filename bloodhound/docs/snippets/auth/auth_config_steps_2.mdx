 ...
 **Automatically create new users on login**
  ...
  Enabling this option will have BloodHound create a new user on the first login with SSO (Just-In-Time). The user will be granted the role passed in the roles claim if included, else the default role will be assigned.
 ...
 **Allow SSO Provider to modify roles**
  ...
  See [User Role Mapping](#user-role-mapping) for roles claim reference. 

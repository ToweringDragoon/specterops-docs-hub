...
If you enable [Variable Analysis Mode](https://github.com/SpecterOps/bloodhound-docs/blob/main//analyze-data/findings/analysis#variable-analysis-mode) on the **Administration** > **Early Access Features** page, analysis triggered by Privilege Zone changes still appears as **Analyzing** in tenant status.

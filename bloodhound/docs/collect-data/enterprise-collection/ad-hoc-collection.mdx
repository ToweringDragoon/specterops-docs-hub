...
It should be used by BloodHound Enterprise users who cannot deploy [SharpHound Enterprise](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-sharphound/system-requirements), for example in:
...
* Logged in as a user role, which is authorized to perform file ingest, see [Administering users and roles](https://github.com/SpecterOps/bloodhound-docs/blob/main//manage-bloodhound/auth/users-and-roles)
...
2. Choose a data collection method
    ...
    * Learn about collection methods and flags:
        * [SharpHound Community Edition](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/ce-collection/sharphound)
        * [All SharpHound Community Edition Flags, Explained](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/ce-collection/sharphound-flags)
        * [SharpHound Data Collection and Permissions](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/permissions)

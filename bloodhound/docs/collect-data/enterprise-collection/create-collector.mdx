...
* Logged in as a user role, which is authorized to create a new collector client, see [Administering users and roles](https://github.com/SpecterOps/bloodhound-docs/blob/main//manage-bloodhound/auth/users-and-roles)

...
For details on what data types can be collected, see [SharpHound Data Collection and Permissions](https://github.com/SpecterOps/bloodhound-docs/blob/main//docs/collect-data/permissions) and [Least-Privileged Collection in SharpHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/enterprise-collection/least-privileged-collection) for information on collecting this data via least-privilege access.

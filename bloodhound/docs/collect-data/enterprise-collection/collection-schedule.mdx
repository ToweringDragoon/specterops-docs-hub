...
* Creation of one SharpHound Enterprise client, see [Create a SharpHound Enterprise collector client](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/enterprise-collection/create-collector)
* Logged in as a user role which is authorized to modify clients, see [User Role Definitions](https://github.com/SpecterOps/bloodhound-docs/blob/main//manage-bloodhound/auth/users-and-roles)
...
<Frame>
  <img src="/assets/image-77.png" alt=""/>
</Frame>
4.  In the _Edit SharpHound Enterprise Client_ window, under the heading _Collection Schedule_, click the **\+ icon** to add a new schedule.
<Frame>
...
5.  In the _Schedule_ window, configure the schedule:
    ...
    * **Data**: The type of data the schedule collects, see [SharpHound Data Collection and Permissions](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/permissions)
    * **Advanced Options**: See the [Scanning section in the article SharpHound Enterprise Tenant Configuration](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-sharphound/tenant-configuration)
<Frame>
  <img src="/assets/image-79.png" alt=""/>
</Frame>
...
<Frame>
  <img src="/assets/image-81.png" alt=""/>
</Frame>

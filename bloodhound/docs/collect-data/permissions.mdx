...
Members of the local Administrators group may call this function. For least-privilege collection, members of the local Print Operators group may also call this function.

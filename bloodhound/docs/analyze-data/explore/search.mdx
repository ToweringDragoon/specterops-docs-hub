...
1. **Layout**—Choose from the following layout options to organize the graph visually:
    ...
    <Tabs>
      ...
      <Tab title="Table">
        ...
        The **Table** layout is available for Cypher searches only and is useful for searching and sorting large sets of data. You can also export the table data as a CSV file for further analysis by clicking the <Icon icon="download" iconType="solid"/> (download) icon.
        ...
        <Tip>
        - Click **Columns** in the top-right corner of the table to add or remove columns.

...
<Note>Pathfinding is available for [structured](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/manage#structured-graphs) graphs only.</Note>

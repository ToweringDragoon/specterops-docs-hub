...
## Open a remediation plan or explore a finding

Select a finding row to open the action bar and continue your investigation or remediation workflow.

<Steps>
  <Step title="Select a finding">
    Click a row in the table to highlight the row and display the action bar at the bottom of the table.
  ...
  <Step title="Choose an action">
    Select one of the following actions (each action opens in a new tab):
...
| Filter | What it does |
| --- | --- |
| **Attack Path** | Search for and select one or more Attack Path finding types. |

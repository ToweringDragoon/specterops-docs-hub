...
The **Attack Paths** page in BloodHound Enterprise surfaces <Tooltip tip="A specific instance of an Attack Path that BloodHound Enterprise has identified as a high-value remediation point." cta="Learn more" href="/analyze-data/findings/attack-paths#findings">findings</Tooltip>. Each finding includes prioritization data such as exposure and impact metrics to help you focus remediation efforts where they matter most.

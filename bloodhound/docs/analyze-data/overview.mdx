...
<Columns cols={2}>
  ...
  <Card title="Use Cases" icon="lightbulb" href="/analyze-data/privilege-zones/use-cases/attack-path-management-journey" horizontal>
    Explore how Privilege Zones help you manage attack paths and reduce risk exposure.
  </Card>

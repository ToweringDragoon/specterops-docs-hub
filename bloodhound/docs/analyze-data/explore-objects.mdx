...
You can also constrain your search to particular node types by prepending your search with the appropriate node label. Supported node names can be found in the [Nodes section](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/overview).

  ...
  <Step title="Complete the certification action">
    ...
    3. *(Optional)* Add a note to document the reason for your action.
       ...
       * Click **Cancel** to exit without completing the certification action
       ...
       <Tip>Notes are visible to all BloodHound users in the [History Log](https://github.com/SpecterOps/bloodhound-docs/blob/main//analyze-data/privilege-zones/history).<img src="/images/privzones/certification-note-history.png" alt="Show certification note in Privilege Zones history log" style={{ width:"100%" }} /></Tip>
  </Step>
</Steps>

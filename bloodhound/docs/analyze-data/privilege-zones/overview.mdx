...
<Callout color="#8E92EB">
  ...
  If you enable [Variable Analysis Mode](https://github.com/SpecterOps/bloodhound-docs/blob/main//analyze-data/findings/analysis#variable-analysis-mode) on the **Administration** > **Early Access Features** page, BloodHound Enterprise can complete analysis for Privilege Zone changes faster because it starts at the **Tagging** stage instead of running the full analysis pipeline.

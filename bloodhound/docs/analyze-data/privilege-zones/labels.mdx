...
<Tabs>
  ...
  The **Summary View** shows label names, selector counts, and member count.
    <img
  ...
  The **Detail View** lists every selector and member that each selector pulls into the associated label.
    <img

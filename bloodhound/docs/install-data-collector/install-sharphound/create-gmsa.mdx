...
<Tip>To learn how to do this with SharpHound Community Edition, see [Create a gMSA for Use With SharpHound Community Edition](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/ce-collection/create-gmsa-community-edition).</Tip>

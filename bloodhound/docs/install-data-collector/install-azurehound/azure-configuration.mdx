...
6.  In the **Overview** menu, copy the **Application (client) ID** and **Directory (tenant) ID** to be used later in [AzureHound Enterprise Local Configuration](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-azurehound/create-configuration)
<Frame>
...
8.  Locate the "cert.pem" file created during AzureHound setup (either on your own, or utilizing the instructions at [AzureHound Enterprise Local Configuration](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-azurehound/create-configuration))
...
11. Continue to [Run and Upgrade AzureHound (Windows, Docker, or Kubernetes)](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-azurehound/installation-options)

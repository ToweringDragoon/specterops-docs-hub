...
1.  Follow the [AzureHound Enterprise System Requirements and Deployment Process](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-azurehound/system-requirements) through deployment in step 3. Deploy and maintain AzureHound: [Run and Upgrade AzureHound (Windows, Docker, or Kubernetes).](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-azurehound/installation-options)

...
Follow the article: [Create a gMSA for SharpHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-sharphound/create-gmsa).
...
Follow the article: [Tiered SharpHound Strategy](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-sharphound/tiered-collector-strategy).

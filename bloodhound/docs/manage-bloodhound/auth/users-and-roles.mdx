...
In BloodHound Enterprise, [Environment Targeted Access Control (ETAC)](https://github.com/SpecterOps/bloodhound-docs/blob/main//manage-bloodhound/auth/environment-targeted-access-control) can further limit which environments **User** and **Read-only** roles can access. ETAC does not change the baseline permissions in the role matrix below. Instead, it limits which environments those permissions apply to.
...
| View Alerts, including Delivery, Rules, and Event History \[BHE\] | <Icon icon="square-check" iconType="solid" color="#22c55e"/> | - | <Icon icon="square-check" iconType="solid" color="#22c55e"/> | - | - | - |
| Create and manage alert webhooks and rules \[BHE\] | <Icon icon="square-check" iconType="solid" color="#22c55e"/> | - | - | - | - | - |

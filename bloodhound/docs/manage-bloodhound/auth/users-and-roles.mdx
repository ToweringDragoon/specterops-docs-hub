...
| View, Search, and Filter Privilege Zones Certification Queue | <Icon icon="xmark"iconType="solid"/>   | <Icon icon="xmark"iconType="solid"/>   | -   | -   | -   |
| View, Search, and Filter Privilege Zones History Log | <Icon icon="xmark"iconType="solid"/>   | <Icon icon="xmark"iconType="solid"/>   | <Icon icon="xmark"iconType="solid"/>   | <Icon icon="xmark"iconType="solid"/>   | -   |
...
| View and Filter Finished Jobs Log and job details panel | <Icon icon="xmark"iconType="solid"/>   | <Icon icon="xmark"iconType="solid"/>   | -   | -   | -   |

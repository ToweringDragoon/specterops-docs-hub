...
9.  Use the downloaded metadata.xml file and follow the instructions at [SAML in BloodHound Enterprise](https://github.com/SpecterOps/bloodhound-docs/blob/main//manage-bloodhound/auth/saml) to Create the SAML Configuration in BloodHound.

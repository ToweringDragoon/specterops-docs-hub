...
4.  [Create new users or modify existing users](https://github.com/SpecterOps/bloodhound-docs/blob/main//manage-bloodhound/auth/users-and-roles) to utilize the newly created OIDC provider.
...
* [Dark-colored icon](https://github.com/SpecterOps/bloodhound-docs/blob/main//assets/31630065613339.png)
* [Light-colored icon](https://github.com/SpecterOps/bloodhound-docs/blob/main//assets/31630065618075.png)

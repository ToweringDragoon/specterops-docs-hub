...
5.  Follow the instructions at [SAML in BloodHound Enterprise](https://github.com/SpecterOps/bloodhound-docs/blob/main//manage-bloodhound/auth/saml) to create the SAML provider in BloodHound Enterprise.

...
<Tip>
  For a step-by-step example on BloodHound Community Edition, see [Enable Transport Layer Security (TLS)](https://github.com/SpecterOps/bloodhound-docs/blob/main//get-started/custom-installation#enable-transport-layer-security-tls) in the custom installation guide.
</Tip>
...
## force_download_embedded_collectors

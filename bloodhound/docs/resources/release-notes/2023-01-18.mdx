...
You'll be able to learn more about the app and how to install it [here](https://github.com/SpecterOps/bloodhound-docs/blob/main//integrations/splunk/install).

...
You'll be able to learn more about the app and how to install it [here](https://github.com/SpecterOps/bloodhound-docs/blob/main//integrations/integrations/splunk).
...
* New Functionality
    * The Explore pane search window now supports the ability to filter for objects by type! Prepend your search term with an object type to improve your search accuracy. Full documentation on this functionality is [here](https://github.com/SpecterOps/bloodhound-docs/blob/main//analyze-data/bloodhound-gui/cypher-search).
<Frame>

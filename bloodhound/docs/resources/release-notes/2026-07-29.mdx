...
<Update label="BloodHound" description="New Feature" tags={["OpenGraph"]}>
  ...
  OpenGraph extensions can now define [custom entity panel content](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/developer/entity-panel-content#custom-entity-panel-content) for node and relationship kinds, including:
...
<Update label="BloodHound" description="Enhancement" tags={["OpenGraph"]}>
  ...
  <EarlyAccessAccessNote feature="OpenGraph Data Quality"/>

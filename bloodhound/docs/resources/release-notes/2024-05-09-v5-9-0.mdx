...
* **Support for ADCS ESC 13** \- (Requires SharpHound v2.4.1+) Identified and described in [this blog](https://specterops.io/blog/2024/02/14/adcs-esc13-abuse-technique/) by Jonas Bülow Knudsen, ESC13 represents another path to full control of target environments utilizing AD Certificate Services. 

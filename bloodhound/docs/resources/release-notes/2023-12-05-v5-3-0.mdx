...
* **\[CE Only\] Added the ability to perform session enumeration as a local admin user (@LuemmelSec, @eversinc33)** \- Added the ability to enumerate local session information utilizing a consistent local administrative user. For more information, see [here](https://github.com/SpecterOps/SharpHound/pull/40).

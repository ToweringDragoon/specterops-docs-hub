...
Instructions to upgrade your collector may be found [here](https://github.com/SpecterOps/bloodhound-docs/blob/main//install-data-collector/install-sharphound/installation-upgrade)! Our Customer Success team will begin reaching out to all customers still running SharpHound v1 and would be happy to help if you require it.

...
* **_\[BHE Only\]_ Completely new Posture page** \- After serving us well for several years, it's time to say goodbye to the old Posture page! [The revamped view](https://github.com/SpecterOps/bloodhound-docs/blob/main//analyze-data/bloodhound-gui/posture-page) is considerably improved over the previous interface in several ways. This includes:
    ...
    * Displays most relevant data within a single page, removing unnecessary scrolling
        ![image3.png](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/release_notes/31706404737563.png)
...
* **Hide node/edge label toggle** \- One of our top feature requests since the release of BloodHound CE, the ability to hide node and edge labels makes a triumphant return! Break out that redaction tool no longer and hide any labels you deem sensitive directly within the UI. Thank you, [@palt](https://github.com/palt), for your contribution!
    ![image1.gif](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/release_notes/31706404739355.png)
* **New CoerceToTGT edge type** \- The [CoerceToTGT](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/coerce-to-tgt) edge indicates principals configured for unconstrained delegation where attackers can coerce privileged computer targets into sending their ticket-granting ticket (TGT) to the attacker and compromise the domain. For all users, this will make these paths appear within the regular course of pathfinding, using Cypher, etc.
    ...
    ![image2.png](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/release_notes/31706404740891.png)
...
* **OIDC Support** \- BloodHound now supports OIDC (as well as SAMLv2) for SSO providers! See [OIDC in BloodHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//manage-bloodhound/auth/oidc) for more details.

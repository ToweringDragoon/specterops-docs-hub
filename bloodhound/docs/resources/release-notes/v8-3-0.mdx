...
- **_[CE Only]_ Privilege Zones enabled by default** - Start organizing your environment right away! Privilege Zones are now enabled by default on all new deployments. This change includes an expanded default definition of Tier Zero to align with SpecterOps' definition of the concept as documented in our [blog](https://specterops.io/blog/2023/06/22/what-is-tier-zero-part-1/) and [GitHub](https://specterops.github.io/TierZeroTable/).

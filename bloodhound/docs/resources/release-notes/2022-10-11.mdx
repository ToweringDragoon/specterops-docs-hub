...
* [Tier Zero Members and Modification](https://github.com/SpecterOps/bloodhound-docs/blob/main//get-started/security-boundaries/tier-zero-members)
* [SAML in BloodHound Enterprise](https://github.com/SpecterOps/bloodhound-docs/blob/main//manage-bloodhound/auth/saml)
...
* BloodHound Enterprise
    * New and Improved Features - [Documentation Portal](https://github.com/SpecterOps/bloodhound-docs/blob/main/) and early access support for user rights assignment collection.

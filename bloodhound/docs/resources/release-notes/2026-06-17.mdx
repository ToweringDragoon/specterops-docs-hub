...
<Update label="OpenHound" description="New Feature" tags={["Data Collection"]}>
  ...
  This update adds support for [GitHub Enterprise](https://github.com/SpecterOps/bloodhound-docs/blob/main//openhound/collectors/github/configure-enterprise-app) environments where SSO blocked OpenHound from accessing repositories through the configured GitHub App.
</Update>

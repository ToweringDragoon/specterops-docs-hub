...
| Federated Identity Credential Application ID | The unique identifier for the [AZApp](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/az-app) object that represents that Azure App Registration. |

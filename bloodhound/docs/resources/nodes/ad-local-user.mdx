...
The following edge types may be linked from this node. See the [edges documentation](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges) for more information on the edge types.

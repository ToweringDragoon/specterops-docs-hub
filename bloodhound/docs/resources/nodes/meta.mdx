...
Any [traversable](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/traversable-edges#traversable-edges) edge type may be linked to/from this node.

...
For example, the image below shows three User nodes (left side) connected to one Group node (right side). The nodes are connected via the "MemberOf" edge. Read more about edges in the article [About BloodHound Edges](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/overview).

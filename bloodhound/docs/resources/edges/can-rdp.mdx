...
This edge will be created under the condition that the user both has membership in Remote Desktop Users and is granted the URA SeRemoteInteractiveLogonRight.  Respectively these two are visualized in BloodHound by the edges [MemberOfLocalGroup](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/member-of-local-group) and [RemoteInteractiveLogonRight](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/remote-interactive-logon-right).

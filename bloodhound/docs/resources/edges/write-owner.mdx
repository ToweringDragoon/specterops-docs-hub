...
Now, with ownership of the object, you may modify the DACL of the object however you wish. For more information about that, see the [WriteDacl](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/write-dacl) edge section.

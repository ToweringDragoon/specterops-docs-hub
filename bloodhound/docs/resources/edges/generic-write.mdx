...
You can compromise child users and computers of the OU by abusing write access to the gPLink attribute of the OU. See the [WriteGPLink](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/write-gp-link) edge documentation for details.

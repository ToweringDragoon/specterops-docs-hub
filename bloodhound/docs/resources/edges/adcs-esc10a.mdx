...
Credentials attack (see [AddKeyCredentialLink edge](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/add-key-credential-link) documentation).

...
The krbtgt credentials can be obtained in multiple ways with administrative access to a DC in the trusted domain, such as via a [DCSync](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/dc-sync) attack.

...
With both [GetChanges](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/get-changes) and [GetChangesAll](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/get-changes-all) privileges in BloodHound, you may perform a dcsync attack to get the password hash of an arbitrary principal using mimikatz:

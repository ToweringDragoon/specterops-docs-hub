...
**Step 4: [DCSync](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/dc-sync) target domain**

Windows:

Use mimikatz to [DCSync](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/dc-sync) the domain from the computer where the DC TGT was injected:
...
Use secretsdump.py to [DCSync](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/dc-sync) the target domain:
...
Source: [User](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/user), [Computer](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/computer)  

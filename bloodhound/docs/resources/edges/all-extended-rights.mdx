...
Having this privilege over a user grants the ability to reset the user’s password. For more information about that, see the [ForceChangePassword](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/force-change-password) edge section

### **Computer**

You may read the LAPS password of the computer object. For more information about that, see the [ReadLAPSPassword](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/read-laps-password) edge section.
...
2.  The principal has [Enroll](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/enroll) permission on the enterprise CA
...
Destination: [User](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/user), [Group](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/group), [Domain](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/domain), [CertTemplate](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/cert-template)  
Traversable: ✅  

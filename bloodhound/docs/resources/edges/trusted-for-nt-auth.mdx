...
The consequence of the relationship is that certificate issued by the Enterprise CA are trusted for authentication in the AD forest of the [NTAuthStore](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/nt-auth-store).
...
Source: [EnterpriseCA](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/enterprise-ca)   
Destination: [NTAuthStore](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/nt-auth-store)   
Traversable: **No**  

...
See the [AllowedToAct](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/allowed-to-act) edge section for abuse info

## Opsec Considerations

See the [AllowedToAct](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/allowed-to-act) edge section for opsec considerations

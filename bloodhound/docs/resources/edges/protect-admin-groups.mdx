...
Any modifications to the AdminSDHolder node's security descriptor via inbound [Owns](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/owns), [WriteOwner](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/write-owner), or
[WriteDACL](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/edges/write-dacl) edges will propagate to all nodes with an inbound ProtectAdminGroups edge from the originating

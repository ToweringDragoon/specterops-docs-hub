...
* [BloodHound Docs](https://github.com/SpecterOps/bloodhound-docs/blob/main//), searchable for various topics and documentation on edges/attack paths
...
* [Searching with Cypher](https://github.com/SpecterOps/bloodhound-docs/blob/main//analyze-data/explore/cypher-search)
...
* "ADCS Attack Paths in BloodHound" series
    * Part 1 [blog post](https://specterops.io/blog/2024/01/24/adcs-attack-paths-in-bloodhound-part-1/)
    * Part 2 [blog post](https://specterops.io/blog/2024/05/01/adcs-attack-paths-in-bloodhound-part-2/)
    * Part 3 [blog post](https://specterops.io/blog/2024/09/11/adcs-attack-paths-in-bloodhound-part-3/)

...
A group of objects representing the hierarchy of control across all domains in an environment based on access level. Zones organize objects into a strict hierarchy that BloodHound uses to measure risk and detect violations.

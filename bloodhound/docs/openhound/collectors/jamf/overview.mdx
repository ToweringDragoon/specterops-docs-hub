---
title: Overview
description: Learn about JamfHound, an OpenGraph extension and data collector for JAMF Pro.
---

<img noZoom src="/assets/enterprise-AND-community-edition-pill-tag.svg" alt="Applies to BloodHound Enterprise and CE"/>

The Jamf collector is a data collector for [JAMF Pro](https://www.jamf.com/products/jamf-pro/) locally hosted and cloud environments that helps security professionals visualize and analyze their JAMF Pro configurations in BloodHound.

It collects data about users, groups, sites, scripts, API integrations, and other entities within a JAMF Pro tenant and represents them as [nodes](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/jamf/schema#nodes) and [edges](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/jamf/schema#edges) in BloodHound's graph database.
...
Please join us in the `#jamf` channel of the [BloodHound Community Slack](https://slack.specterops.io/) workspace if you want to chat about attack paths in JAMF or the usage of the Jamf collector. You are also welcome to open an issue or pull request on [GitHub](https://github.com/SpecterOps/openhound-jamf).

...
- [Enterprise GitHub App installation](https://github.com/SpecterOps/bloodhound-docs/blob/main//openhound/collectors/github/configure-enterprise-app): Use this option when you need enterprise-scoped collection (<Badge color="green">recommended</Badge>).

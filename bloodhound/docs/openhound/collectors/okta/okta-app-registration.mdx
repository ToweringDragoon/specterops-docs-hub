...
description: Create an API service application in Okta to authenticate and collect data from your Okta organization.
---

<img noZoom src="/assets/enterprise-AND-community-edition-pill-tag.svg" alt="Applies to BloodHound Enterprise and CE"/>

The Okta collector authenticates to the Okta API using an OAuth 2.0 service application with a public/private key pair.

To create the Okta application registration for the Okta collector, follow the steps below.

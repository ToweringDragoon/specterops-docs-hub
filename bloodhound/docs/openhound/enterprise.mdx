...
<Tabs>
  <Tab title="config.toml">
    <Note>
      For a full description of these and other available runtime parameters, see [Configuration](https://github.com/SpecterOps/bloodhound-docs/blob/main//openhound/configuration).
    </Note>

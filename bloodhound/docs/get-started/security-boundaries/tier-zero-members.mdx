...
Jonas Bülow Knudsen, one of our BloodHound Enterprise team members, has written this fantastic blog on implementing a tiering model in your environment: [Establish security boundaries in your on-prem AD and Azure environment](https://specterops.io/blog/2022/06/20/establish-security-boundaries-in-your-on-prem-ad-and-azure-environment/).
...
* Read-Only Domain Controller (RODC) computer objects
    * Read about why the RODC computer objects are Tier Zero and how RODCs should be configured to protect Tier Zero here: [What is Tier Zero - Part 2](https://specterops.io/blog/2023/09/14/what-is-tier-zero-part-2/).

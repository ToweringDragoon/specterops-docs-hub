...
1. Review the OpenHound for BloodHound Enterprise [configuration requirements](https://github.com/SpecterOps/bloodhound-docs/blob/main//openhound/enterprise).
1. Create an OpenHound [collector client](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/enterprise-collection/create-collector) to get API credentials.
1. Configure the OpenHound collector you want to run:
    - [Github](https://github.com/SpecterOps/bloodhound-docs/blob/main//openhound/collectors/github/collect-data#configure-openhound)
    - [Jamf](https://github.com/SpecterOps/bloodhound-docs/blob/main//openhound/collectors/jamf/collect-data#configure-openhound)
    - [Okta](https://github.com/SpecterOps/bloodhound-docs/blob/main//openhound/collectors/okta/collect-data#configure-openhound)
1. Deploy OpenHound in your environment and run an on-demand scan or scheduled collection.
...
2. Verify that each collector has collected the expected amount of data and that principal types match your expected coverage for each directory and platform.
   ...
   <Note>
    For more information, see [Review Data Quality](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/data-quality).
   </Note>
...
2. [Mark your environment's Tier Zero objects in BloodHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//analyze-data/privilege-zones/overview).

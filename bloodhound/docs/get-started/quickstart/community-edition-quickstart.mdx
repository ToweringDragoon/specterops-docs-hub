...
import InstallWarning from '/snippets/get-started/install-warning.mdx';
  ...
  <Tab title="Option 2: Data collectors (more realistic)" icon="microchip">
    ...
    <Steps>
      ...
      <Step title="Download a collector">
        ...
        <Note>
          To install the OpenHound CLI and configure supported collectors, see [OpenHound Community](https://github.com/SpecterOps/bloodhound-docs/blob/main//openhound/community).
        </Note>
      ...
      <Step title="Run a collector">
        ...
        - [OpenHound CLI](https://github.com/SpecterOps/bloodhound-docs/blob/main//openhound/community#cli-commands)
        </Tip>
      </Step>
...
<Steps>
  <Step title="Search for a user">
    ...
    1. Select the user and click on the node that appears.

    1. Explore information about the user's sessions and memberships.
  </Step>
  ...
  <Step title="Pathfind">
    ...
    To route through additional objects, select **Add Destination** and enter up to two more destination nodes in the order you want BloodHound to traverse them.
  </Step>
...
<Tip>Learn more in [Explore → Search for Objects](https://github.com/SpecterOps/bloodhound-docs/blob/main//analyze-data/explore/search).</Tip>

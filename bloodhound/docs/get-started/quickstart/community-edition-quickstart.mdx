...
* Download from GitHub releases: [SharpHound releases](https://github.com/SpecterOps/SharpHound/releases/latest) or [AzureHound releases](https://github.com/SpecterOps/AzureHound/releases/latest).
* Build the collector from source with the source code for [SharpHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/ce-collection/sharphound) or [AzureHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/ce-collection/azurehound).
...
For Azure argument definitions, see [All AzureHound Community Edition Flags, Explained](https://github.com/SpecterOps/bloodhound-docs/blob/main//collect-data/ce-collection/azurehound-flags).
...
Learn more in [Explore → Search for Objects](https://github.com/SpecterOps/bloodhound-docs/blob/main//analyze-data/bloodhound-gui/explore-objects).

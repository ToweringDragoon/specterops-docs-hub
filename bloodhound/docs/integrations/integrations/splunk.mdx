...
The [BloodHound Enterprise Splunk app](https://splunkbase.splunk.com/app/6609) ingests your BloodHound Enterprise data into Splunk.
...
6.  If you have not already, create an API key/ID pair, following [Create a non-personal API Key/ID pair](https://github.com/SpecterOps/bloodhound-docs/blob/main//integrations/bloodhound-api/working-with-api#create-a-non-personal-api-key-id-pair)

...
Our API reference is available [here](https://github.com/SpecterOps/bloodhound-docs/blob/main/../../reference/).
...
* Non-personal API key/ID pairs for integrations like [Splunk](https://github.com/SpecterOps/bloodhound-docs/blob/main//integrations/splunk/install)
...
2. [Create a new BloodHound user](https://github.com/SpecterOps/bloodhound-docs/blob/main/../../manage-bloodhound/auth/users-and-roles).
...
<CardGroup>
  <Card title="apiclient.py 10KB" icon="paperclip" href="/assets/apiclient.py" iconType="solid" horizontal />
</CardGroup>

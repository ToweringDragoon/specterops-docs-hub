...
<Tip>You configure the [data inputs](https://github.com/SpecterOps/bloodhound-docs/blob/main//integrations/splunk/install#configure-the-splunk-app-required) for these dashboards during the installation and configuration of the BloodHound Enterprise Splunk app.</Tip>
...
<Frame>
  <img 
    src="/images/integrations/splunk/posture-exposure-percentage.png"
    alt="A view of the Posture History Exposure panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/posture-findings.png"
    alt="A view of the Posture History Findings panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/posture-attack-path.png"
    alt="A view of the Posture History Attack Path panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/posture-assets.png"
    alt="A view of the Posture History Assets panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-paths-total.png"
    alt="A view of the Attack Paths Total Domain Wise Attack Paths per Domain panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-paths-severity.png"
    alt="A view of the Attack Paths Severity Breakdown panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-paths-top-principals.png"
    alt="A view of the Attack Paths Top 5 Non-Tier Zero Principals Involved panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-paths-top-findings-common.png"
    alt="A view of the Attack Paths Top 5 Most Common Findings panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-paths-top-findings-environment.png"
    alt="A view of the Attack Paths Top 5 Most Common Findings Per Environment panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-paths-top-ten.png"
    alt="A view of the Attack Paths Top 10 Attack Paths by Exposure panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
This panel shows the all principals based on the selected filters.
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-path-details-principals.png"
    alt="A view of the Attack Paths Details Principals panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-path-details-max-exposure.png"
    alt="A view of the Attack Paths Details Maximum Exposure Percentage panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-path-details-total-findings.png"
    alt="A view of the Attack Paths Details Total Number of Findings panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/attack-paths-finding-trends.png"
    alt="A view of the Attack Paths Finding Trends panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/audit-logs.png"
    alt="A view of the Audit Logs dashboard in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/tier-zero-assets-list.png"
    alt="A view of the Tier Zero Assets List panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
<Frame>
  <img 
    src="/images/integrations/splunk/tier-zero-assets-distribution.png"
    alt="A view of the Tier Zero Assets Distribution By Environment panel in the BloodHound Enterprise Splunk app"
  />
</Frame>
...
See [install and configure](https://github.com/SpecterOps/bloodhound-docs/blob/main//integrations/splunk/install) the BloodHound Enterprise Splunk app for details about configuring data inputs and other administrative tasks.

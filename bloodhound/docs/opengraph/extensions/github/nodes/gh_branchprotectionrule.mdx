...
For complete analysis, see [BloodHound Docs: GitHound - Mitigating Controls](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/github/mitigating-controls).

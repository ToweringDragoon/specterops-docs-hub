...
| `last_seen` | `datetime` | - |
| `node_id` | `str` | - |
| `database_id` | `int \| None` | The organization's numeric GitHub database ID used in immutable OIDC subjects. |
...
| `github_deployment_type` | `str \| None` | The GitHub deployment type, such as `ghec` or `ghes`. |
| `ghes_version` | `str \| None` | The GitHub Enterprise Server version, when applicable. |

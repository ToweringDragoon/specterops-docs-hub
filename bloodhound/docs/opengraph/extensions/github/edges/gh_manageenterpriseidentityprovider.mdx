---
title: 'GH_ManageEnterpriseIdentityProvider'
...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_EnterpriseRole](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/github/nodes/gh_enterpriserole) | GH_ManageEnterpriseIdentityProvider | [GH_Enterprise](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/github/nodes/gh_enterprise) |

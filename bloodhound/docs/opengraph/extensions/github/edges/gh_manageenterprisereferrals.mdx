---
title: 'GH_ManageEnterpriseReferrals'
...
| Start | Kind | End |
|-------|-----------|-------|
| [GH_EnterpriseRole](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/github/nodes/gh_enterpriserole) | GH_ManageEnterpriseReferrals | [GH_Enterprise](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/github/nodes/gh_enterprise) |

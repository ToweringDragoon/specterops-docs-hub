...
description: "Default Privilege Zone rules for the GitHound extension"
icon: "gem"
---

<img noZoom src="/assets/enterprise-AND-community-edition-pill-tag.svg" alt="Applies to BloodHound Enterprise and CE"/>
The following Cypher rules define the default Privilege Zone for the GitHound extension.
Each rule is defined in a JSON file located in the [PrivilegeZoneRules](https://github.com/SpecterOps/GitHound/tree/main/pz-rules) directory of the GitHound repository.
...
This rule is defined in the [t0-all-repo-admin-role.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-all-repo-admin-role.json) file.
...
This rule is defined in the [t0-app-installations-all-repos.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-app-installations-all-repos.json) file.
...
This rule is defined in the [t0-apps-all-repos.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-apps-all-repos.json) file.
...
This rule is defined in the [t0-external-identities-owners.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-external-identities-owners.json) file.
...
This rule is defined in the [t0-organizations.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-organizations.json) file.
...
This rule is defined in the [t0-owner-users.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-owner-users.json) file.
...
This rule is defined in the [t0-owners-role.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-owners-role.json) file.
...
This rule is defined in the [t0-pats-all-repos.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-pats-all-repos.json) file.
...
This rule is defined in the [t0-privilege-escalation-roles.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-privilege-escalation-roles.json) file.
...
This rule is defined in the [t0-privilege-escalation-users.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-privilege-escalation-users.json) file.
...
This rule is defined in the [t0-saml-identity-providers.json](https://github.com/SpecterOps/GitHound/tree/main/pz-rules/t0-saml-identity-providers.json) file.

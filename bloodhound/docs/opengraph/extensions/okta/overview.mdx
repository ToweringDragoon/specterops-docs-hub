...
In BloodHound Enterprise, Okta is supported as a pre-installed extension. Use [OpenGraph Extension Management](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/manage) to verify the installed version or upload a newer supported schema manually.

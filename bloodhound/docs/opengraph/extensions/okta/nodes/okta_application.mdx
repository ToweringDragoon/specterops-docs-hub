...
Applications are represented as Okta_Application nodes in BloodHound.
## Edges
...
| --------- | ----------------- | ----------- |
| [Okta_AgentPoolFor](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_agentpoolfor) | [Okta_AgentPool](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_agentpool) | ✅ |
...
| [Okta_GroupPush](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_grouppush) | [Okta_Group](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_group) | ❌ |
| [Okta_KerberosSSO](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_kerberossso) | [User](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/user) | ✅ |
| [Okta_KeyOf](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_keyof) | [Okta_JWK](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_jwk) | ✅ |
| [Okta_ManageApp](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_manageapp) | [Okta_User](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_user), [Okta_Group](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_group), [Okta_Application](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_application) | ✅ |
| [Okta_PolicyMapping](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_policymapping) | [Okta_Policy](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_policy) | ❌ |
...
| [Okta_UserPush](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_userpush) | [Okta_User](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_user) | ❌ |
...
| [Okta_GroupPull](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_grouppull) | [Okta_Group](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_group) | ✅ |
...
| [Okta_OrgSWA](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_orgswa) | [GH_Organization](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/github/nodes/gh_organization), [jamf_SSOIntegration](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/jamf/nodes/jamf_ssointegration), [OP_Account](https://github.com/SpecterOps/1PassHound), [SNOW_Account](https://github.com/SpecterOps/SnowHound) | ❌ |
| [Okta_OutboundOrgSSO](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_outboundorgsso) | [AZTenant](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/az-tenant), [GH_Organization](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/github/nodes/gh_organization), [jamf_SSOIntegration](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/jamf/nodes/jamf_ssointegration), [SNOW_Account](https://github.com/SpecterOps/SnowHound), [Okta_IdentityProvider](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_identityprovider) | ✅ |
...
| [Okta_ReadPasswordUpdates](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_readpasswordupdates) | [Okta_User](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_user) | ✅ |
...
| [Okta_UserPull](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/edges/okta_userpull) | [Okta_User](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_user) | ❌ |
...
![Okta Application scopes and roles in BloodHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/bloodhound-app-scopes.png)
...
![Okta AD agent settings](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/okta-ad-agent.png)
...
![Properties of the GitHub Application node](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/bloodhound-github-properties.png)
...
![Jamf Pro SAML application in BloodHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/bloodhound-jamf-saml-properties.png)

It is also possible to integrate Jamf Pro with Okta using Secure Web Authentication (SWA), but this option is less secure.

![Jamf Pro SWA settings](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/app-jamf-swa.png)
...
![Google Workspace SAML application in BloodHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/bloodhound-google-saml-properties.png)

The SAML 2.0 protocol should always be preferred to SWA when integrating Okta with Google Workspace:

![Google Workspace sign-in protocol settings](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/app-google-protocol-selector.png)
...
![Okta SAML application in BloodHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/bloodhound-app-saml.png)
...
![Okta SWA application in BloodHound](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/bloodhound-app-swa.png)
...
![Okta application OIDC grants](https://github.com/SpecterOps/bloodhound-docs/blob/main//images/extensions/okta/app-oidc-grants.png)

...
The traversable Okta_KeyOf edges represent the relationships between applications [Okta_Application](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/okta/nodes/okta_application) and their JWKs:

...
| --------- | ----------------- | ----------- |
| [Okta_HostsAgent](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/oktahound/reference/edges/okta_hostsagent) | [Computer](https://bloodhound.specterops.io/resources/nodes/computer) | ✅ |

...
One or more agents are grouped into Agent Pools, represented by the [Okta_AgentPool](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/oktahound/reference/nodes/okta_agentpool) nodes, to provide redundancy and load balancing.
...
| --------- | ----------------- | ----------- |
| [Okta_HostsAgent](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/oktahound/reference/edges/okta_hostsagent) | [Computer](https://github.com/SpecterOps/bloodhound-docs/blob/main//resources/nodes/computer) | ✅ |

### Outbound Edges

| Edge Type | Destination Node Types | Traversable |
| --------- | ---------------------- | ----------- |
| [Okta_AgentMemberOf](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/oktahound/reference/edges/okta_agentmemberof) | [Okta_AgentPool](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/oktahound/reference/nodes/okta_agentpool) | ✅ |
...
| `poolName` | `agentPool.name` | `string` | Name of the parent [Okta_AgentPool](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/oktahound/reference/nodes/okta_agentpool). For AD pools this typically corresponds to the synced AD domain. |

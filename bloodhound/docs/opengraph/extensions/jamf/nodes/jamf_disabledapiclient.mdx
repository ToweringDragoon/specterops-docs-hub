...
> This node shares its property set with [jamf_ApiClient](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/jamf/nodes/jamf_apiclient). The difference is that the client's `enabled` property is false.

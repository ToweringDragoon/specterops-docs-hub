...
- Destination: [GH_ExternalIdentity](https://bloodhound.specterops.io/opengraph/extensions/github/nodes/gh_externalidentity), [GH_Group](https://bloodhound.specterops.io/opengraph/extensions/github/nodes/gh_group)
- Traversable: ✅

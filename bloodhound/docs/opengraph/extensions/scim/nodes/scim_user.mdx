...
icon: '/images/extensions/scim/scim_user.png'
---
...
| --------- | ----------------- | ----------- |
| [SCIM_Contains](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/edges/scim_contains) | [SCIM_Organization](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/nodes/scim_organization) | ✅ |
| [SCIM_ManagerOf](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/edges/scim_managerof) | [SCIM_User](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/nodes/scim_user) | ❌ |

### Outbound Edges

| Edge Type | Destination Node Types | Traversable |
| --------- | ---------------------- | ----------- |
| [SCIM_HasRole](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/edges/scim_hasrole) | [SCIM_Role](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/nodes/scim_role) | ✅ |
| [SCIM_ManagerOf](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/edges/scim_managerof) | [SCIM_User](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/nodes/scim_user) | ❌ |
| [SCIM_MemberOf](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/edges/scim_memberof) | [SCIM_Group](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/nodes/scim_group) | ✅ |
| [SCIM_Provisioned](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/scim/edges/scim_provisioned) | [GH_ExternalIdentity](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/github/nodes/gh_externalidentity), [GH_EnterpriseTeam](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/github/nodes/gh_enterpriseteam) | ✅ |

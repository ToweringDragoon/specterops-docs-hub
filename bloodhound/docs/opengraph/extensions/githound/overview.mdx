...
It collects data about organizations, users, teams, repositories, branches, roles, secrets, GitHub Apps, and other entities within a GitHub organization and represents them as [nodes](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/githound/reference/schema#nodes) and [edges](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/extensions/githound/reference/schema#edges) in BloodHound's graph database.

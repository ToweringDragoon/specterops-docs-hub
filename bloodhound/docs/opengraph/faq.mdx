...
Yes you can!
You can find all the details [here](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/developer/custom-icons)
</Accordion>
...
- **Second payload (linking AD/AZ nodes)**: Link the isolated subgraph's nodes to the AD/AZ nodes that connect your subgraph to existing AD/AZ entities. This avoids cross-source side effects when `source_kind` is present.
  ...
  <Note>
    Do **not** define `source_kind` in the second payload.
  </Note>
</Accordion>
</AccordionGroup>

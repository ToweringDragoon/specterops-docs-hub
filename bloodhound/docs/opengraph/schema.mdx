...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or [download this sample file](https://github.com/SpecterOps/bloodhound-docs/blob/main//download/opengraph-node.json).
...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or [download this sample file](https://github.com/SpecterOps/bloodhound-docs/blob/main//download/opengraph-edge.json).
...
The following is an example that you can use as a starting point to build your own OpenGraph. Copy and paste the following sample into a new `.json` file or [download this sample file](https://github.com/SpecterOps/bloodhound-docs/blob/main//download/opengraph-minimal.json).

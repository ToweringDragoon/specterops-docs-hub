...
<ResponseField name="properties" type="object">
  ...
  See [Property rules](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/developer/nodes#property-rules) and [Reserved properties](https://github.com/SpecterOps/bloodhound-docs/blob/main//opengraph/developer/nodes#reserved-properties) below for details on allowed property formats and reserved property names.
</ResponseField>
